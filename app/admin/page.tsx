...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7FBF8] text-[#172331]">
      ...
      {toastMessage && (
        <div 
          className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-2xl text-white font-medium text-sm transition-all transform animate-bounce ${
            toastMessage.type === 'success' ? 'bg-[#087F5B]' : 'bg-red-600'
          }`}
        >
            ...
            <form onSubmit={handleSubmitGame} className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              {activeModalTab === 'basic' && (
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#5D6B78] mb-1">
                      Download APK Link / URL <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="url"
