      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center min-h-0 lg:min-h-[72vh]">
          ...
          <div className="order-2 lg:order-1 lg:col-span-6 space-y-6 sm:space-y-8 z-10 text-center lg:text-left">
            ...
            <div
              ref={badgeRef}
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#EEF8F2] border border-[#087F5B]/20 text-[#07553F] text-xs sm:text-sm font-semibold shadow-xs"
            >
              <Gamepad2 className="w-4 h-4 text-[#087F5B]" />

              <span>Yono Games &amp; Mobile Gaming</span>
            </div>
            ...
            >
              Discover Your Next{' '}
              <span className="text-[#087F5B] block sm:inline">
                Favourite Game.
              </span>
            </h1>
            ...
            >
              Explore Yono games, arcade games, card games, and popular mobile
              gaming titles — all in one place with useful game information
              and updates.
            </p>
            ...
            >
              ...
              >
                <svg
                  className="w-4 h-4 sm:w-5 sm:h-5 text-[#24A1DE] flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
