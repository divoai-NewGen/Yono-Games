  ...
  const steps = [
    {
      ...
      title: 'Discover',
      description:
        'Browse our collection of Yono games, arcade titles, card games, board games, and other popular mobile gaming experiences.',
      icon: Compass,
    },
    {
      number: '02',
      title: 'Explore',
      description:
        'Review game information, features, gameplay details, available resources, and other useful information before choosing a title.',
      icon: CheckSquare,
    },
    {
      number: '03',
      title: 'Learn More',
      description:
        'Open the individual game page to find detailed information, updates, screenshots, and relevant resources for the selected game.',
      icon: DownloadCloud,
    },
    {
      number: '04',
      title: 'Get Started',
      description:
        'Follow the available information and resources to learn more about the game and explore its features on your device.',
      icon: PlayCircle,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-sm sm:text-base text-[#5D6B78] mt-2">
            Discover games, explore useful information, and find the resources
